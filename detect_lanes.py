...
class LaneDetector(object):
    ...
    def process_image(self, image):
        ...
        result = cv2.addWeighted(image, 1, unwarped_lanes, 0.4, 0)
    ...
    def detect_video(self, inp_file, out_file):
        out_clip = VideoFileClip(inp_file).fl_image(self.process_image)
        out_clip.write_videofile(out_file, audio=False, verbose=False)
        return out_clip


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Detecting road lanes')
